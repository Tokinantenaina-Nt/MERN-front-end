...
const FriendsHint = () => {
  ...
  const [FriendsHint, setFriendsHit] = useState([]);
  ...
  useEffect(() => {
    const notFriendList = () => {
      ...
      if (window.innerHeight > 720) array.length = 4;
      if (window.innerHeight > 615) array.length = 3;
      if (window.innerHeight > 540) array.length = 2;
      else array.length = 0;
      setFriendsHit(array);
    };
